...
public class ExtraMath
{
    ...
    public static BlockHitResult playerRaycast(LivingEntity player, ClipContext.Fluid fluidHandling, double range)
    {
        ...
        return player.level().clip(new ClipContext(vec3d, vec3d2, ClipContext.Block.OUTLINE, fluidHandling, player));
    }
}
